...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(kindergarten.registryReport()); // Registered children in Sunshine: // -- // Child: Sara Gomez, Age: 2, Contact info: Victor - 0998 // -- // Child: Tom Todorov, Age: 2, Contact info: Zendaya - 0799 // -- // Child: Greta Thunberg, Age: 3, Contact info: Boris - 0999 // -- // Child: Lilyana Petrova, Age: 3, Contact info: Selena - 0899 // -- // Child: Veselina Kostadinova, Age: 3, Contact info: Nikolas - 0788
